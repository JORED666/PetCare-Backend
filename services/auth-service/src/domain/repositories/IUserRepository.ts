...
export interface IUserRepository {
  ...
  updateProfile(id: number, rol: string, data: { nombre?: string; apellido?: string; email?: string; telefono?: string; cedula_profesional?: string; avatar_url?: string }): Promise<void>;

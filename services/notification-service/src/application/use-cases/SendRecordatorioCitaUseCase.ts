...
export class SendRecordatorioCitaUseCase {
  ...
  async executeRecordatorio24h(): Promise<void> {
    ...
    const en24h  = new Date(ahora.getTime() + (24 * 60 - 5) * 60 * 1000);
    const margen = new Date(ahora.getTime() + (24 * 60 + 5) * 60 * 1000);
  ...
  async executeRecordatorio1h(): Promise<void> {
    const ahora  = new Date();
    const en1h   = new Date(ahora.getTime() + 55 * 60 * 1000);
    const margen = new Date(ahora.getTime() + 65 * 60 * 1000);
